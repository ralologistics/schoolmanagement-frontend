...
import { AddSubjectCard, SubjectListCard } from '../components/subject'
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <nav>
          <ol className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <li className="text-slate-400">|</li>
            <li className="text-slate-800 font-medium">Subject</li>
          </ol>
        </nav>
      </div>

      {/* Two column: Add Subject (left) + Subject List (right) */}
